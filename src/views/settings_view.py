...
class SettingsView(ctk.CTkFrame):
    ...
    def __init__(self, master, on_theme_change: Callable[[str], None]):
        ...
        ctk.CTkLabel(
            copy,
            text="Escolha o tema da interface. A preferência fica guardada.",
            anchor="w",
    ...
    def _alterar_tema(self) -> None:
        ...
        nome = "escuro" if theme == "dark" else "claro"
        self.status.configure(text=f"Tema {nome} aplicado e guardado.")
